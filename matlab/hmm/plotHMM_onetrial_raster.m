...
for m=1:max(state_nums)
    ...
    plot(linspace(win_size(1),win_size(2),size(trial_forward_probs,2)),squeeze(trial_forward_probs(state_idx,:)),'Color',colors(m,:),'LineWidth',1.5);
